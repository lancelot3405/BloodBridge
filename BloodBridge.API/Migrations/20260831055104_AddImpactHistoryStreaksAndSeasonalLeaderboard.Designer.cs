...
namespace BloodBridge.API.Migrations
{
    ...
    [Migration("20260831055104_AddImpactHistoryStreaksAndSeasonalLeaderboard")]
    partial class AddImpactHistoryStreaksAndSeasonalLeaderboard
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BloodBridge.API.Models.GamificationActivity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DonorId", "ActivityKey")
                        .IsUnique();

                    b.ToTable("GamificationActivities");
                });

            modelBuilder.Entity("BloodBridge.API.Models.GamificationProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("ProfileCompletedXPGranted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bit")
            ...
            modelBuilder.Entity("BloodBridge.API.Models.ImpactActivityLog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("DonorId", "EarnedAt");

                    b.ToTable("ImpactActivityLogs");
                });
            ...
            modelBuilder.Entity("BloodBridge.API.Models.GamificationProfile", b =>
                {
                    b.HasOne("BloodBridge.API.Models.Donor", "Donor")
                        ...
                        .HasForeignKey("BloodBridge.API.Models.GamificationProfile", "DonorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
